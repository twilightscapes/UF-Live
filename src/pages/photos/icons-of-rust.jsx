...
<Seo
          title={`Icons of Rust Photography`}
          description={`Urban Fetish Photography of Rusted Vehicles`}
          image={'https://urbanfetish.com/images/vehicles/vehicles-abandoned23.jpg'}
        />
  {/* <GalleryMenu /> */}
...
query rustPhotos {
  allFile(
    filter: {relativeDirectory: {eq: "vehicles"}, relativePath: {}}
