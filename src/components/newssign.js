...
<form  style={{width:'90%', margin:'0 auto', display:'flex', flexDirection:'column', justifyContent:'center', background: 'rgba(0,0,0,0.50)',
  backdropFilter: 'blur(4px)', border:'1px solid #000', borderRadius:'12px', textAlign:'center', alignSelf:'center', overflow:'hidden', color:'#fff'}}
          ...
          <input type="hidden" name="form-name" value="news" />
              ...
              <div className="txtshadow" style={{fontSize:'120%', textAlign:'center', marginTop:'10px'}}><strong>Free Monthly Digital Magazine</strong></div>
              
              <span className="txtshadow" style={{fontSize:'85%'}}>Get uour FREE copy of Urban Fetish digital magazine.<br /> Showcasing the very best of abandoned<br /> photography and urban exploration</span>
